...
const { FeedImportError, importFeed } = require('./_lib/feed-import');
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const result = await importFeed(requestedUrl);
    ...
    sendJson(req, res, 500, { message: error instanceof Error ? error.message : '导入 RSS 失败。' });
  }
};
